 ...
 * @author brayan
 */
public class JFramePassChallenger extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(JFramePassChallenger.class.getName());
    private Main main;
    private JFrameLevel framePassChallenger;
    /**
     * Creates new form JFramePassChallenger
     */
    ...
    public void printAnswer(boolean pastChallenge){
        if (pastChallenge){
            jLabelAnswer.setText("FELICIDADES LA RESPUESTA ES CORRECTA");
        }else{
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(99, 99, 99)
                .addComponent(jLabelAnswer, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(50, 50, 50)
                .addComponent(Continue)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new JFramePassChallenger().setVisible(true));
    }
